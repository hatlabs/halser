...
1. Always use heat shrink tubing on the individual wires
2. Slide the heat shrink onto the wires **before** soldering
3. Add solder to the connector pin cavity first, then re-melt and insert the wire
